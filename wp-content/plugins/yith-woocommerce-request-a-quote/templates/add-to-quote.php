...
<div class="yith-ywraq-add-to-quote add-to-quote-<?php echo $product_id ?>">
    ...
    <?php if( $exists ): ?>
        ...
        <div id="buttonvisu" class="yith_ywraq_add_item_browse-list-<?php echo $product_id ?> yith_ywraq_add_item_browse_message"><a href="<?php echo  $rqa_url ?>"><?php echo $label_browse ?></a></div>
    <?php endif ?>
</div>
